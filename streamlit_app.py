...
for question_id, (num1, num2) in lcm_questions.items():
    ...
    multiples_num1 = st.text_area(f"Multiples of {num1} (comma-separated):", placeholder=f"3, 6, 9...", key=f"multiples_num1_{question_id}")
    
    # Input for multiples of num2
    multiples_num2 = st.text_area(f"Multiples of {num2} (comma-separated):", placeholder=f"3, 6, 9...", key=f"multiples_num2_{question_id}")
